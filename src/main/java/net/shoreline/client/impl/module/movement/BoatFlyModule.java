...
public class BoatFlyModule extends ToggleModule {
    ...
    Config<Float> forwardSpeed = new NumberConfig<>("ForwardSpeed", "Speed while moving forward", 0.1f, 1.0f, 100.0f);
    Config<Float> backwardSpeed = new NumberConfig<>("BackwardSpeed", "Speed while moving backward", 0.1f, 1.0f, 100.0f);
    Config<Float> upwardSpeed = new NumberConfig<>("UpwardSpeed", "Speed while moving upward", 0.1f, 1.0f, 1000.0f);
