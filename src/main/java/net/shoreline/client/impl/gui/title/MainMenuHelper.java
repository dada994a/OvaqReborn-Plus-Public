...
public class MainMenuHelper extends Screen implements Globals {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        // 文字
        RenderManager.tf.drawStringShadow(context.getMatrices(), OvaqRebornMod.MOD_NAME + " " + OvaqRebornMod.MOD_VER + " Made by hypinohaizin", 2F, (float) (7.5 + mc.textRenderer.fontHeight + 4), -1);
        ...
        RenderManager.tf.drawString(context.getMatrices(), "Changelogs for " + OvaqRebornMod.MOD_VER, 10, 50, -1);
